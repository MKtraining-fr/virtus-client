        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-700 dark:text-client-subtle mt-1">
              Les fichiers que vous téléversez ici sont stockés de manière sécurisée et ne sont
              visibles que par votre coach.
            </p>
          </div>
        </div>
      </Card>
        ...
        {(user?.sharedFiles || []).length > 0 ? (
          ...
          <div className="text-center py-10">
            ...
            <p className="text-gray-500 dark:text-client-subtle mt-1">
              Téléversez des bilans, des photos ou tout autre document à partager.
            </p>
          </div>
        )}
      </div>
