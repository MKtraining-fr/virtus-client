...
export const NAV_ITEMS = [
  { name: 'Tableau de bord', path: '/app', icon: <Squares2x2Icon className="w-6 h-6" />, subItems: [] },
  { name: 'Mes clients', path: '/app/clients', icon: <UserGroupIcon className="w-6 h-6" />, subItems: [] },
  {
    name: 'Bilan', path: '/app/bilan', icon: <ClipboardDocumentListIcon className="w-6 h-6" />, subItems: [
  ...
  {
    name: 'Musculation', path: '/app/musculation', icon: <FireIcon className="w-6 h-6" />, subItems: [
  ...
  {
    name: 'Nutrition', path: '/app/nutrition', icon: <BeakerIcon className="w-6 h-6" />, subItems: [
  ...
  { name: 'Formation', path: '/app/formations', icon: <AcademicCapIcon className="w-6 h-6" />, subItems: [] },
  { name: 'Boutique', path: '/app/shop', icon: <ShoppingBagIcon className="w-6 h-6" />, subItems: [] },
  { name: 'Messagerie', path: '/app/messagerie', icon: <ChatBubbleLeftRightIcon className="w-6 h-6" />, subItems: [] },
  { name: 'Paramètres', path: '/app/parametres', icon: <Cog6ToothIcon className="w-6 h-6" />, subItems: [] },
];
