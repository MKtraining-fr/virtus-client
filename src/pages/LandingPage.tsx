...
import { UserGroupIcon, ClipboardDocumentCheckIcon, ChatBubbleLeftRightIcon, DevicePhoneMobileIcon, ChartBarIcon } from '../constants/icons';
                ...
                <section className="bg-white text-center py-20 lg:py-32">
                    <div className="container mx-auto px-6">
                        ...
                        <p className="mt-6 text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto">
                            Virtus est la plateforme tout-en-un conçue pour les coachs sportifs exigeants et leurs clients déterminés.
