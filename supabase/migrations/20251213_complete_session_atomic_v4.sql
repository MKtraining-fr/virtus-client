-- Migration: Fonction RPC atomique pour terminer une séance (VERSION 4 - FIX ON CONFLICT)
-- Date: 2025-12-13
-- Description: Retrait du ON CONFLICT car pas de contrainte unique
...
-- ============================================================================
-- FONCTION: complete_client_session_atomic (VERSION 4)
-- ============================================================================
  ...
  LOOP
    ...
    IF FOUND THEN
      ...
      LOOP
        ...
        -- ✅ FIX: Retrait du ON CONFLICT car pas de contrainte unique
...
VERSION 4 - Retrait du ON CONFLICT.
...
Différences avec V3:
  - Retrait du ON CONFLICT car pas de contrainte unique sur (client_session_exercise_id, set_number)
  - Simple INSERT sans gestion des doublons

Note:
  La validation "déjà complétée" en étape 1 empêche normalement les doublons.
...
DO $$
BEGIN
  RAISE NOTICE '=== Migration complete_client_session_atomic V4 terminée ===';
  RAISE NOTICE 'Fonction mise à jour: complete_client_session_atomic';
  RAISE NOTICE 'Fix: Retrait du ON CONFLICT';
