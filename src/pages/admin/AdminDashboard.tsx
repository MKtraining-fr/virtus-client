            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <Link to="/app/import" className="h-full">
                    <Card className="p-6 text-center hover:shadow-primary/20 h-full">
                        ...
                        <p className="mt-2 text-sm text-gray-500">Importer des exercices ou d'autres données via des fichiers CSV.</p>
                    </Card>
                </Link>
                <Link to="/app/stats" className="h-full">
                    <Card className="p-6 text-center hover:shadow-primary/20 h-full">
                        ...
                        <p className="mt-2 text-sm text-gray-500">Visualisez les données clés et les métriques d'utilisation de la plateforme.</p>
                    </Card>
                </Link>
            </div>
        </div>
