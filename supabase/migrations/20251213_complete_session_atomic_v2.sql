-- Migration: Fonction RPC atomique pour terminer une séance (VERSION CORRIGÉE)
-- Date: 2025-12-13
-- Description: Crée une fonction PostgreSQL pour terminer une séance de manière atomique
--              Adaptée au schéma réel de la base de données
...
-- ============================================================================
-- FONCTION: complete_client_session_atomic (VERSION 2)
-- ============================================================================
...
VERSION 2 - Adaptée au schéma réel de la base de données.
...
Différences avec V1:
  - Suppression de client_exercise_performance.client_session_id (n''existe pas)
  - Suppression de la création du log principal (pas nécessaire)
  - Utilise client_session_exercise_id pour lier les performances
  - Retourne client_session_id au lieu de performance_log_id
...
DO $$
BEGIN
  RAISE NOTICE '=== Migration complete_client_session_atomic V2 terminée ===';
  RAISE NOTICE 'Fonction mise à jour: complete_client_session_atomic';
  RAISE NOTICE 'Cette version est adaptée au schéma réel de la base de données';
