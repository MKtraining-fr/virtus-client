...
export const UpdateClientProfileSchema = z.object({
  ...
  phone: z.string().regex(/^(\+33|0)[1-9](\d{2}){4}$/).optional().or(z.literal('')),
  ...
  energyExpenditureLevel: z.enum(['Sédentaire', 'Légèrement actif', 'Actif', 'Très actif']).optional(),
});
...
export const CreateExerciseSchema = z.object({
  ...
  illustrationUrl: z
    .string()
    .url('URL d\'illustration invalide')
    .optional()
    .or(z.literal('')),
