...
const NutritionCard: React.FC<{ title: string; to: string; description: string }> = ({
  title,
  to,
  description,
}) => (
  <Link
    to={to}
    className="bg-white dark:bg-client-card rounded-lg p-4 flex justify-between items-center w-full hover:bg-primary/10 dark:hover:bg-primary/20 transition-colors group"
  >
    <div>
