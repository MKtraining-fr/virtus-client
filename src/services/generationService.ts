...
export const generateMealPlan = async (planName: string): Promise<Record<string, string>> => {
    ...
    const mealPlans: Record<string, Record<string, string>> = {
        'perte_de_poids': {
            "petit_dejeuner": "Flocons d'avoine (50g) avec des fruits rouges (100g) et une poignée d'amandes (15g).",
            "collation_du_matin": "Yaourt grec 0% (150g) avec une cuillère de miel (10g).",
            "dejeuner": "Poitrine de poulet grillée (150g), quinoa (150g cuit) et légumes verts à la vapeur (200g).",
            "collation_de_l_apres_midi": "Une pomme (150g) avec une cuillère de beurre de cacahuètes (15g).",
            "diner": "Filet de saumon au four (150g) avec des patates douces rôties (150g) et des brocolis (200g)."
        },
        'prise_de_masse': {
            ...
            "dejeuner": "Bœuf maigre (200g), riz basmati (250g cuit), haricots verts (150g) et huile d'olive (15ml).",
        ...
        'maintien': {
            "petit_dejeuner": "Porridge d'avoine (60g) avec lait demi-écrémé, fruits secs (20g) et cannelle.",
            ...
            "diner": "Poisson blanc (150g), riz complet (150g cuit), ratatouille (200g) et huile d'olive (10ml)."
        },
        'vegetarien': {
            "petit_dejeuner": "Smoothie bowl aux fruits (banane, fruits rouges) avec granola (40g) et graines de chia (10g).",
            ...
            "collation_de_l_apres_midi": "Yaourt végétal (150g) avec des noix (20g) et du sirop d'érable (10g).",
        ...
        'default': {
            ...
            "dejeuner": "Protéine au choix (150g), féculents complets (180g cuit) et légumes variés (200g).",
            "collation_de_l_apres_midi": "Fruit de saison (150g) avec une poignée d'oléagineux (15g).",
            "diner": "Poisson ou viande maigre (150g), accompagnement de féculents (150g) et légumes (200g)."
        }
    };
    ...
    } else if (planLower.includes('masse') || planLower.includes('muscle') || planLower.includes('volume')) {
