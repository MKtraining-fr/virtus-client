...
/**
 * Page de sélection des techniques d'intensification
 * Sous-page des réglages IronTrack
 */

const IntensityTechniquesSettings: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white flex flex-col">
      ...
      <header className="flex-none bg-zinc-900/50 backdrop-blur-xl border-b border-zinc-800/50 px-4 py-3 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-lg font-black uppercase tracking-tight">Techniques d'intensification</h1>
          <p className="text-xs text-zinc-400 flex items-center gap-1.5">
            <span className="bg-orange-500/20 text-orange-400 text-[10px] font-bold px-1.5 py-0.5 rounded uppercase">DEV</span>
            Temporaire
          </p>
        </div>
      </header>
...
export default IntensityTechniquesSettings;
