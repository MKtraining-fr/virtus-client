    ...
    try {
      ...
      if (error.message) {
        if (error.message.includes('rate limit')) {
          ...
          errorMessage =
            "Le service d'envoi d'emails n'est pas configuré. Veuillez contacter l'administrateur.";
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-light-bg">
      <div className="relative w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
        <Link
          to="/"
          className="absolute top-4 left-4 text-gray-500 hover:text-primary transition-colors"
        ...
        <div className="space-y-4">
          ...
          {dataError && (
            <div className="p-3 text-sm text-red-700 bg-red-100 rounded-md">{dataError}</div>
          )}
        </div>
          ...
          >
            <div className="text-center p-4">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Un email de confirmation a été envoyé à <strong>{email}</strong>. Veuillez cliquer
                sur le lien dans cet email pour valider votre compte.
              </p>
              <Button
                onClick={() => {
