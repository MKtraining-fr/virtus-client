...
const GlossaireLibrary: React.FC = () => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="text-center py-16 bg-white dark:bg-client-card rounded-lg border border-gray-400 dark:border-transparent">
        ...
        <p className="text-gray-500 dark:text-client-subtle mt-1">
          Cette section contiendra les définitions des termes techniques.
        </p>
      </div>
    </div>
  );
