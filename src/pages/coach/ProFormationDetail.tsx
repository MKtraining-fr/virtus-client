    ...
    if (!formation) {
        return (
            <div className="text-center">
                ...
                <p className="text-gray-600 mt-2">La formation que vous cherchez n'existe pas ou a été supprimée.</p>
                <Button onClick={() => navigate('/app/formations')} className="mt-4">Retour aux formations</Button>
            </div>
        );
    }
    ...
    return (
        <div>
            ...
            <Card className="overflow-hidden">
                <img src={formation.coverImageUrl} alt={formation.title} className="w-full h-64 object-cover" />
                <div className="p-8">
                    <div className="flex flex-wrap justify-between items-start gap-4 mb-4">
                        ...
                        <div className="text-right">
                             ...
                             <p className="text-sm text-gray-500 capitalize">{formation.accessType === 'purchase' ? 'Achat unique' : 'Abonnement requis'}</p>
                        </div>
                    </div>
