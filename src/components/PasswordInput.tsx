...
const PasswordInput: React.FC<PasswordInputProps> = ({ label, id, className = '', error, ...props }) => {
    ...
    <div className="w-full">
      ...
      <div className="relative">
        <input
          ...
          } rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary text-gray-900 placeholder:text-gray-500 dark:bg-client-card dark:border-gray-600 dark:text-client-light dark:placeholder:text-client-subtle pr-10 ${className}`}
          {...props}
        />
        <button
          type="button"
